...
The local `replace github.com/thanet-s/inspace-cloud-kube-modules/cloud-provider-inspace => ../cloud-provider-inspace` resolves the shared SDK module inside this monorepo.
