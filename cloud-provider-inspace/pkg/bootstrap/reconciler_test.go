...
import (
	...
	"github.com/thanet-s/inspace-cloud-kube-modules/cloud-provider-inspace/api/v1alpha1"
...
func (f *fakeAPI) CreateFirewall(_ context.Context, _ string, request inspace.CreateFirewallRequest) (*inspace.Firewall, error) {
	...
	item := inspace.Firewall{UUID: "77777777-1111-4222-8333-444444444444", DisplayName: request.DisplayName, Rules: request.Rules}
