...
`github.com/thanet-s/inspace-cloud-kube-modules/cloud-provider-inspace/pkg/inspace` client for disk
...
```sh
docker build --platform=linux/amd64 -f inspace-csi-driver/Dockerfile \
