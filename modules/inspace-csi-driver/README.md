...
`github.com/thanet-s/inspace-cloud-kube-modules/modules/cloud-provider-inspace/pkg/inspace` client for disk
...
```sh
docker build --platform=linux/amd64 -f modules/inspace-csi-driver/Dockerfile \
